...
#   nohup python3 main.py --cuda --dataSet=$1 --mode=fedego --seed=$3 > result/out_$1/out_$1_fedego_$3_3e-3_200.txt 2>&1 &
...
if [ $2 = --adaptive ]; then
# nohup python3 main.py --cuda --dataSet=$1 --mode=fedego --seed=$3 --lamb_fixed=0 > result/lamb_$1/lamb_adaptive_$3.txt 2>&1 &
...
#   nohup python3 main.py --cuda --dataSet=$1 --mode=fedego --seed=$3 --lamb_c=1 --lamb_fixed=1 > result/lamb_$1/lamb_fixed_server_$3.txt 2>&1 &
fi 
...
#   nohup python3 main.py --cuda --dataSet=$1 --mode=fedego_ne --seed=$3 --early_stopping=500 > result/abation_$1/fedego_ne_$3.txt 2>&1 &
...
if [ $2 = --batch ]; then
#   nohup python3 main.py --cuda --dataSet=$1 --mode=fedego --seed=$3 --batch_size=8 --early_stopping=500 --timing=1 --cal_cost> result/batch_$1/8_$3.txt 2>&1 &
#   nohup python3 main.py --cuda --dataSet=$1 --mode=fedego --seed=$3 --batch_size=16 --early_stopping=500 --timing=1 --cal_cost> result/batch_$1/16_$3.txt 2>&1 &
#   nohup python3 main.py --cuda --dataSet=$1 --mode=fedego --seed=$3 --batch_size=32 --early_stopping=500 --timing=1 --cal_cost> result/batch_$1/32_$3.txt 2>&1 &
#   nohup python3 main.py --cuda --dataSet=$1 --mode=fedego --seed=$3 --batch_size=64 --early_stopping=500 --timing=1 --cal_cost> result/batch_$1/64_$3.txt 2>&1 &
#   nohup python3 main.py --cuda --dataSet=$1 --mode=fedego --seed=$3 --batch_size=128 --early_stopping=500 --timing=1 --cal_cost> result/batch_$1/128_$3.txt 2>&1 &
  nohup python3 main.py --cuda --dataSet=$1 --mode=fedavg --seed=$3 --early_stopping=500 --timing=1 --cal_cost> result/batch_$1/fedavg_128_$3.txt 2>&1 &
fi 

if [ $2 = --linear ]; then
  nohup python3 main.py --cuda --dataSet=$1 --mode=fedego --seed=$3 --linear> result/linear_$1/linear_$3.txt 2>&1 &
fi
